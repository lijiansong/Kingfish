...
def make_request_handler_class(opts):
    ...
    class MyRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            # REF: https://stackoverflow.com/questions/4233218/python-how-do-i-get-key-value-pairs-from-the-basehttprequesthandler-http-post-h
...
def daemonize(opts):
    ...
    REF: https://stackoverflow.com/questions/115974/what-would-be-the-simplest-way-to-daemonize-a-python-script-in-linux
    '''
